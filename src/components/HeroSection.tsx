...
// import useFitWidth from "..assets/useFitWidth";
    ...
    >
      ...
      <div className="overflow-hidden w-full mt-6 sm:mt-4 md:-mt-5">
        <FadeIn delay={0.15} y={40} as="h1">
          <h1 className="hero-heading font-black uppercase tracking-tight leading-none whitespace-nowrap w-full text-[14vw] sm:text-[15vw] md:text-[16vw] lg:text-[15.7vw]">
            Hi, i&apos;m ronnie
          </h1>
        </FadeIn>
      </div>
      ...
      <div className="flex justify-between items-end pb-7 sm:pb-8 md:pb-10 px-6 md:px-10 mt-auto relative z-20">
        <FadeIn delay={0.35} y={20}>
          ...
          >
            A BACKEND DEVELOPER DRIVEN BY CRAFTING ROBUST AND UNFORGETTABLE
            PROJECTS{" "}
          </p>
        </FadeIn>
